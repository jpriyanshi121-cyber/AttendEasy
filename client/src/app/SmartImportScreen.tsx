...
export default function SmartImportScreen({
  ...
  // Not tied to real backend progress — a single non-streaming request is
  // what's actually reliable here (a prior attempt at making this track
  // real progress via a streamed response repeatedly broke extraction
  // outright, and isn't something verifiable without live access to test
  // against). This just paces the checklist to roughly how long a typical
  // extraction takes, so the wait doesn't feel dead.
  useEffect(() => {
